#!/usr/bin/env python3
"""
MP3File class for handling MP3 audio files with ID3 tags
"""
...
class MP3File(AudioFileBase):
    """Handles MP3 files with ID3 tags"""
    
    SUPPORTED_EXTENSIONS = {'.mp3'}
    
    def load(self):
        """Load the MP3 file and extract tags"""
        try:
    ...
    def save_tags(self, new_tags: Dict[str, str]):
        """Save updated tags to the MP3 file"""
        try:
            # Ensure tags exist
